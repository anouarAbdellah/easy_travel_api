            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{route('add_post')}}" class="btn btn-sm btn-neutral">Ajouter</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush" id="dataTable">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="sort" data-sort="status">Post id</th>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{route('edit_post', $post->id)}}">Modifier</a>
                                                <a class="dropdown-item" href="{{route('delete_post', $post->id)}}">Supprimer</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
