                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('update_profile', Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4 mb-4">
                                ...
                                <input type="text" value="{{Auth::user()->name}}"  required class="form-control" name="name" id="name">
                            </div>
                            <div class="form-group mt-4 mb-4">
                                <label for="email">Email :</label>
                                <input type="email" value="{{Auth::user()->email}}"  required class="form-control" name="email" id="email">
                            </div>
                            <div class="form-group mt-4 mb-4">
