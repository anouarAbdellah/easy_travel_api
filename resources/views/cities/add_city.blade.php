            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('save_city')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mt-4 mb-4">
                                ...
                                <input type="text" value="{{ old('lat') }}" required class="form-control" name="lat" id="lat">
                            </div>
                            <div class="form-group mt-4 mb-4">
                                <label for="lng">Lng :</label>
                                <input type="text" value="{{ old('lng') }}" required class="form-control" name="lng" id="lng">
                            </div>
                            <div class="form-group mt-4 mb-4">
