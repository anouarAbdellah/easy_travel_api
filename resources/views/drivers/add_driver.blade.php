            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('save_driver')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mt-4 mb-4">
                                ...
                                <input type="text" value="{{ old('phone') }}" required class="form-control" name="phone" id="phone">
                            </div>
                            <div class="form-group mt-4 mb-4">
                                <label for="rib">rib :</label>
                                <input type="text" value="{{ old('rib') }}" required class="form-control" name="rib" id="rib">
                            </div>
                            <div class="form-group mt-4 mb-4">
                                <label for="cin">cin :</label>
                                <input type="text" value="{{ old('cin') }}" required class="form-control" name="cin" id="cin">
                            </div>
                            <div class="form-group mt-4 mb-4">
